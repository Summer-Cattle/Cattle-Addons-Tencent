 ...
 */
package io.github.summercattle.addons.wechat.officialaccounts.event.noreply;
...
@RcvEvent(ReceiveEventType.View)
public abstract class ViewEvent extends NoReplyEvent {
	...
	public void from(Element element) throws CommonException {
		url = element.elementText("EventKey");
	}
