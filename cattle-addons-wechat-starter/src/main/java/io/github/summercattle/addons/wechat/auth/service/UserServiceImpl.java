 ...
 */
package io.github.summercattle.addons.wechat.auth.service;
...
import io.github.summercattle.addons.wechat.auth.UserSession;
import io.github.summercattle.addons.wechat.auth.bind.UserBindAuthType;
import io.github.summercattle.addons.wechat.auth.bind.UserBindHandle;
...
import io.github.summercattle.addons.wechat.configure.WeChatConfigProperties;
import io.github.summercattle.addons.wechat.constants.WeChatExceptionConstants;
...
public class UserServiceImpl implements UserService {
	...
	public void generateBindCaptcha(String source, String sessionId, UserBindObjectType objectType, String userObject, int captchaLength,
		...
		if (StringUtils.isBlank(captcha)) {
			captcha = io.github.summercattle.commons.utils.auxiliary.StringUtils.getRandomString(true, captchaLength);
	...
	public void bind(String source, String sessionId, UserBindObjectType objectType, UserBindAuthType authType, String userObject, String authInfo,
		...
		RedisTemplateUtils redisUtils = SpringContext.getBean(RedisTemplateUtils.class);
		String key = WECHAT_SESSION + source + "_" + sessionId;
		if (redisUtils.exists(key)) {
			redisUtils.del(key);
		}
	...
	public UserSession[] getSessions(String source) throws CommonException {
		RedisTemplateUtils redisUtils = SpringContext.getBean(RedisTemplateUtils.class);
		Set<String> keys = redisUtils.keys(WECHAT_SESSION + source + "_" + "*");
